	...
	if (msgArray.length === 0) {
		...
		if (uniformName !== false && uniforms[uniformName].name !== false) {
			...
			if (player.team == 1) {
				...
				room.setTeamColors(player.team, uniforms[uniformName].angle2, uniforms[uniformName].textcolor2,[uniforms[uniformName].color21, uniforms[uniformName].color22, uniforms[uniformName].color23]);
